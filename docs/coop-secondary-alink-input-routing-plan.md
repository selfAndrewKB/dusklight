...
The next completed milestones were `docs/coop-secondary-alink-item-ownership-plan.md` and
`docs/coop-native-split-screen-camera-plan.md`. Current work is tracked in
`docs/coop-enemy-audit.md`.
