...
| High risk | `d_a_e_po.cpp` | `E_PO` | 63 | special/ghost-like | Generic Poe is handled in `E_HP`; this high-density Poe variant still needs a dedicated ghost/down-owner pass because wolf-down pull, soul/item presentation, roll/holl demos, camera/player placement, and special death flow are not simple combat targeting. |
...
| Candidate | `d_a_e_ym.cpp` | `E_YM` | 31 | Shadow Insect / Yami Mushi | File/header evidence identifies the Twilight Tear Shadow Insect family. Many wolf-eye, bark, dig, front-roll, tear-collection, camera visibility, and Midna-sensitive paths need a dedicated Shadow Insect retained/event presentation pass. |
...
| `d_a_e_po.cpp` | `E_PO` | 63 | special/ghost-like likely | High-density Poe variant; generic Poe is `E_HP`. Needs dedicated down/soul-owner plus presentation pass for wolf-down pull, soul/item presentation, roll/holl demos, camera/player placement, and special death flow |
...
| `d_a_e_ym.cpp` | `E_YM` | 32 | Shadow Insect / Yami Mushi | Twilight Tear Shadow Insect family; wolf-eye, bark, dig, front-roll, tear-collection, camera visibility, and Midna-sensitive paths need a dedicated pass |
