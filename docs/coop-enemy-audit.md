...
| `d_a_e_gb.cpp` | `E_GB` | HIO label `デカババ`; head/flower actions, bomb-eat, drop-key demo | plant/special enemy | Giant Baba / Big Deku Baba. Head combat targeting and boomerang awareness are implemented pending validation; flower/body, bomb-eat, key/drop, and demo presentation remain authored P1/global or object-owned behavior. |
...
| `d_a_e_hb.cpp` | `E_HB` | HIO label `デグババ（ボックリ）`; stay/appear/wait/attack/chance actions | plant enemy candidate | Deku Baba / Bokkuri Baba. Combat targeting, damage/defender ownership, and retained bite/caught ownership are implemented pending validation. |
...
| `d_a_e_sm.cpp` | `E_SM` | Chu Worm / Slime | 3 | 2 | 0 | **Focused pass implemented pending validation** — action-wide XZ angle/distance, wake/LOS, defender contact, loose hookshot awareness, and retained hook carry are covered; demo/camera presentation remains P1/global |
...
| `d_a_e_gb.cpp` | `E_GB` | 17 | plant/special enemy | Giant Baba / Big Deku Baba; head combat targeting and boomerang awareness converted pending validation; bomb/key/demo presentation remains P1/global or object-owned |
...
| `d_a_e_hb.cpp` | `E_HB` | 17 | plant enemy candidate | Deku Baba / Bokkuri Baba; combat targeting, damage/defender ownership, and retained bite ownership converted pending validation |
...
| `d_a_e_sm.cpp` | `E_SM` | 13 | retained-interaction enemy candidate | Chu Worm / スライム (Slime); combat targeting, defender contact, hookshot awareness, and retained hook carry converted pending validation; demo/camera presentation remains P1/global |
