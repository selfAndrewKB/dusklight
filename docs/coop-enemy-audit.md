...
| Converted, pending validation | `d_a_e_dn.cpp` | `E_DN` | 25 | Lizalfos / Dynalfos | Wake/LOS, action cache, wolf bark, selected hookshot-flight status, defender guard, damage-owner reactions, and wolf-catch lifetime are converted pending field testing. Hookshot shoot/return learn reactions, cut-bit/learn-defense globals, death/demo/talk, and authored event/horse presentation remain deferred. |
...
| `d_a_e_dn.cpp` | `E_DN` | 26 | complex humanoid enemy | Lizalfos/Dynalfos; wake/LOS, action-wide cache, wolf bark, hookshot-flight status, defender guard, damage-owner reactions, and wolf-catch lifetime converted pending validation; hookshot shoot/return learn reactions, cut-bit/learn-defense globals, death/demo/talk, and authored event/horse presentation deferred |
