...
| `d_a_e_tk_ball.cpp` | `E_TK_BALL` | 3 | helper/projectile | Tadpole projectile; launch aim inherits parent Combat target and sword-reflection cut state uses `damage_owner` |
