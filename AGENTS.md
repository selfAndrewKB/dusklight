...
- `docs/coop-enemy-audit.md`: current enemy/world acknowledgement map; `E_FK`, `E_HZ`, and `E_BUG` are first-pass validated, `E_GOB` is the deferred Dangoro miniboss, and the next untouched regular-enemy batch is the active selection surface.
