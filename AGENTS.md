...
- Future `ui_owner` work must absorb the already-touched Hawkeye, boomerang, and fishing rod viewport/UI fixes; do not leave them as one-off item patches when HUD ownership expands.
