...
- For added-player defects, begin with the question: "What vanilla lifecycle, state write, replay, or presentation pass is P2 missing?" Restore that missing native work at its ownership boundary before considering local correction code. Apply this principle to gameplay, UI, camera, and rendering work.
