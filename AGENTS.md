...
- `docs/coop-enemy-audit.md`: current enemy/world acknowledgement map; Darknut, Goron, and Aeralfos mixed combat passes are first-pass validated, with the first-Goron intro presentation collapse awaiting direct field confirmation.
