...
- `docs/coop-player-horse-ownership-plan.md`: active Epona milestone: canonical campaign horse compatibility, additional-player runtime clones, rider-local control, rein interpolation, collision, and authored-system classification.
